...
public class LinkedList {
	...
	/** この{@lin LinkedList}が持つ要素 */
	private Object element = null;
	/** この{@lin LinkedList}の次の{@link LinkedList}への参照 */
	...
	/**
	 * このリストが持つリストをたどり最後に見つかった{@link LinkedList}を返す
	 * @return 最後の{@link LinkedList}インスタンス
	 */
	...
	/**
	 * 新たな{@link LinkedList}インスタンスを生成し、現在のインスタンスのnextフィールドに生成したインスタンスを入れる
	 * @param 生成する{@link LinkedList}インスタンスの要素
	 */
