...
public class ImageTranfsformer {
	...
	public static void main(String[] args) {
		 ...
		 *
		 */
		Function<Color, Color> f = op.compose(Color::grayscale);
		// UnaryOperatorに代入できない
//		UnaryOperator<Color> f = op.compose(Color::grayscale);
//		Image finalImage = transform(image, f);
